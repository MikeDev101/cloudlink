...
class callback_examples:
    ...
    async def on_connect(self, client):
        ...
        #logging in
        await client.send_raw_packet({"cmd":"sign_up", "username":"a", "password":"b"})
        
        await sleep(1)
        await client.send_raw_packet({"cmd":"sign_in", "username":"a", "password":"b"})
        ...
        await sleep(1)  
        await client.send_raw_packet({"cmd":"update_disk", "disk_id":0, "val":"updated"})
