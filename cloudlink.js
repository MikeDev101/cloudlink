...
class cloudlink {
    constructor(runtime, extensionId) {
        ...
        this.gotNewGlobalData = false;
        this.gotNewPrivateData = false;
    ...
    getInfo() {
        return {
            ...
            blocks: [{
                ...
                {
                    opcode: 'gotNewGlobalData',
                    blockType: Scratch.BlockType.BOOLEAN,
                    text: 'Got New Data (Global)?',
                },
                {
                    opcode: 'gotNewPrivateData',
                    blockType: Scratch.BlockType.BOOLEAN,
    ...
    gotNewGlobalData() {
        return this.gotNewGlobalData;
    }
    gotNewPrivateData() {
        return this.gotNewPrivateData;
    }
    resetGotNewGlobalData() {
        const self = this;
        self.gotNewGlobalData = false;
    }
    resetGotNewPrivateData() {
        const self = this;
        self.gotNewPrivateData = false;
    }
}
