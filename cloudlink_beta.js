...
class cloudlink {
  constructor (runtime){
    ...
    this.linkIDs = []; // List for indexing multiple websocket connection streams.
    this.links = []; // List for accessing websocket connection objects.
    this.linkStates = {}; // Dictionary for indexing multiple websocket connection states.
  }
  ...
  getInfo (){
    return {
      ...
      blocks: [
        ...
        {
          opcode: 'getLinkState', // Returns true or false if a link is connected or not.
        ...
        },
        {
          ...
          text: 'Got new data from Link ID: [linkID]?'
        },
        {
        ...
        },
        {
          ...
          text: 'Send Data: [packetData] Privately to [userID] through Link ID: [linkID]'
        },
        {
